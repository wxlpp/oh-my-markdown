...
**After completion**: Confirm "✅ Created N tasks for epic: <name>"

**Gate: Cross-Review** — Before syncing to GitHub, invoke `copilot-cross-review` on the epic and its task files. Address all 🔴 Critical and applicable 🟡 items before syncing.

After review passes: "Ready to push to GitHub? Say: sync the <name> epic"
