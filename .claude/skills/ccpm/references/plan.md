...
**After creation**: Confirm "✅ PRD created: `.claude/prds/<name>.md`"

**Gate: Cross-Review** — Before proceeding to epic creation, invoke `copilot-cross-review` on the PRD file. Address all 🔴 Critical and applicable 🟡 items before moving on.

After review passes: "Ready to create technical epic? Say: parse the <name> PRD"
...
**After creation**: Confirm "✅ Epic created: `.claude/epics/<name>/epic.md`"

**Gate: Cross-Review** — Before proceeding to task decomposition, invoke `copilot-cross-review` on the epic file. Address all 🔴 Critical and applicable 🟡 items before moving on.

After review passes: "Ready to decompose into tasks? Say: decompose the <name> epic"
