...
public struct MarkdownReviewText: View {
    ...
    public init(_ source: String, documentID: String, revision: String, annotations: [MarkdownAnnotation] = [], inlineCommentHeights: [String: CGFloat] = [:], onInlineCommentLayout: @escaping @MainActor ([String: CGRect]) -> Void = { _ in }, commentActionTitle: String = "Comment", isCommentingEnabled: Bool = true, copyActionTitle: String? = nil, copyMarkdownSourceActionTitle: String? = nil, onComment: @escaping @MainActor (MarkdownSelectionSnapshot) -> Void, onAnnotationTap: @escaping @MainActor (String) -> Void = { _ in }) {
        self.source = source
        self.configuration = MarkdownReviewConfiguration(documentID: documentID, revision: revision, annotations: annotations, inlineCommentHeights: inlineCommentHeights, onInlineCommentLayout: onInlineCommentLayout, commentActionTitle: commentActionTitle, isCommentingEnabled: isCommentingEnabled, copyActionTitle: copyActionTitle, copyMarkdownSourceActionTitle: copyMarkdownSourceActionTitle, onComment: onComment, onAnnotationTap: onAnnotationTap)
    }
